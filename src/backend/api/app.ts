...
import { type AppRuntime, appRuntime, REQUIRED_ENV } from './context.js';
...
export function createApp(runtime: AppRuntime) {
  ...
  app.get('/cron', async (c) => {
    ...
    const exit = await runtime.runPromiseExit(runCron(overrideHour));
...
export default createApp(appRuntime);
